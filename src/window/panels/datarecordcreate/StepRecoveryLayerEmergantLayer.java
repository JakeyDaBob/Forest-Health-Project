...
public class StepRecoveryLayerEmergantLayer extends StepChooseOption
{
    public static final int LayerIndex = 4;

    public StepRecoveryLayerEmergantLayer(JLayeredPane parentPanel, DataContext context)
    {
    ...
    {
        context.record.recoveryEmergantLayer = RecoveryEmergantLayer.values()[optionSelectPanel.getId()];
    }
}
