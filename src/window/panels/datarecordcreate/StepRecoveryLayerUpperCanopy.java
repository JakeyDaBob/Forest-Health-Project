...
public class StepRecoveryLayerUpperCanopy extends StepChooseOption
{
    public static final int LayerIndex = 3;

    public StepRecoveryLayerUpperCanopy(JLayeredPane parentPanel, DataContext context)
    {
    ...
    {
        context.record.recoveryUpperCanopy = RecoveryUpperCanopyLayer.values()[optionSelectPanel.getId()];
    }
}
