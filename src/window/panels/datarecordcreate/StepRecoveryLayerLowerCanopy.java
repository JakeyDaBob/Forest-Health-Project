...
public class StepRecoveryLayerLowerCanopy extends StepChooseOption
{
    public static final int LayerIndex = 2;

    public StepRecoveryLayerLowerCanopy(JLayeredPane parentPanel, DataContext context)
    {
    ...
    {
        context.record.recoveryLowerCanopy = RecoveryLowerCanopyLayer.values()[optionSelectPanel.getId()];
    }
}
